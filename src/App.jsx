...
function App() {
  ...
  const projectsData = [
      ...
      details: [
        ...
        'I architected a serverless backend on AWS using Lambda and API Gateway for the API layer, DynamoDB for player data storage, and S3 for static assets, giving me hands-on experience designing and deploying real cloud infrastructure.',
        'I configured CloudFront and ACM to serve the app over a custom domain through Route 53, handling SSL/TLS, caching, and DNS configuration end-to-end.',
      ],
